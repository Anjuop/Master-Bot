...
(((((((((((((((((((((((@MASTERBOT22)))))))))))))))))))))))))))
(((((((((((((((((((((((@MASTERBOT22)))))))))))))))))))))))))))
           MADE BY @MASTERBOT22 dont kang this plugin
         CREDITS = @MASTERBOT22 @PROBOYX @alain_champion
...
from . import legend
from MASTERBOT import BOT, PHOTO, VERSION
...
async def amireallyalive(awake):
   ...
   if PHOTO:
     ...
     ALIVE_MESSAGE += f"💠 [𝙳𝙴𝙿𝙻𝙾𝚈](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FMASTERBOTOP%2FLEGEN-BOT&template=https%3A%2F%2Fgithub.com%2FMASTERBOTOP%2FLEGEND-ROBOT) 𝚈𝙾𝚄𝚁 𝙾𝚆𝙽 𝙾𝙿 [{BOT}](http://github.com/legendxop/legend-bot)  💠\n"   
     await awake.delete() 
