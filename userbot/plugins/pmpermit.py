...
#    maked by MASTERBOT22 🔥🔥🔥🔥 helper shivam ⚡⚡⚡
    ...
    if event.is_private:
        ...
        if not lightning_sql.is_approved(chats.id):
            ...
            await borg.send_message(
                ...
                chats, "**Heya @MASTERBOT22 YOU ARE MY CREATOR I APPROVED YOU SIR ❤️🥰🔥⚜️**"
    ...
    if event.is_private:
        ...
        if not lightning_sql.is_approved(chats.id):
            ...
            await borg.send_message(
                ...
                chats, f"**Good To See You @MASTERBOT22 How Can I Disapprove You Come In Sir**ðð"
